...
I created this pull request because I wanted to get a feel for NewRetirement's code, and to present my automation bona fides. 

This PR includes:
* a wrapper for the NewRetirement marketing site. This wrapper uses an advanced page object model built on my router design pattern.
