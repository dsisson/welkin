...
I created this pull request because I wanted to get a feel for Teladoc Health's code, and to present my automation bona fides. 

This PR includes:
* a wrapper for the Teladoc Health marketing site. This wrapper uses an advanced page object model built on my router design pattern.
