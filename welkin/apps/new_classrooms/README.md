...
I created this pull request because I wanted to get a feel for New Classroom's code, and to demonstrate my approach to test automation. The marketing site is a WordPress and therefore a very rough proxy.
...
This PR includes:
* a wrapper for the New Classrooms marketing site. This wrapper uses an advanced page object model built on my router design pattern.
