...
I created this pull request because I wanted to get a feel for LeoLabs' code, and to demonstrate my approach to test automation. 

Granted, I wrote this against the LeoLab's marketing site, so it doesn't represent the complexity of your actual product code. On the other hand, the value of this approach is it already has a way to run tests, and "all" that's needed is the wrappers and models for your actual systems (plus a lot of learning and experimentation).   

This PR includes:
* a wrapper for the LeoLabs marketing site. This wrapper uses an advanced page object model built on my router design pattern.
