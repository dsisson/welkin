...
I created this pull request because I wanted to get a feel for Earnest's code, and to demonstrate my approach to test automation, and the role of advanced modeling in a modern automation approach. This is just the marketing site, so probably doesn't reflect core tech competencies. 
...
This PR includes:
* a wrapper for the Earnest marketing site. This wrapper uses an advanced page object model built on my router design pattern.
