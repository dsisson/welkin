...
from welkin.apps.examples.baffle.base_page import BaseWrapperPageObject
        ...
        target_links = {
            'PRODUCT': {
                'Data Protection Services': {
                    'sel': 'Data Protection Services',
                    'po': 'baffle data protection services page',
                    'target': '/advanced-data-protection/'
                }
            },
            'SOLUTIONS': {
                'Solutions Overview': {
                    'sel': 'Solutions Overview',
                    'po': 'baffle solutions overview page',
                    'target': '/solutions/'
                }
            },
            'RESOURCES': {
                'Resources Overview': {
                    'sel': 'Resources Overview',
                    'po': 'baffle resources overview page',
                    'target': '/resources/'
                }
            },
        }
