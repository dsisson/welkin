...
Welkin is designed to focus on testing from the customer experience: testing the surfaces as *customers* would; it's not focused on the *developer* experience or the *developer's* natural pre-occupation with code implementation details.
...
I created this pull request because I wanted to get a feel for Photobooth Supply Company's code. 

This PR includes:
* a wrapper for the Photobooth Supply Company marketing site. This wrapper uses an advanced page object model built on my router design pattern.
...
I'm happy to provide the test artefacts and logs, and to explain my design decisions. 
