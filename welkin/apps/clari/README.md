...
I created this pull request because I wanted to get a feel for Clari's code, and to demonstrate my approach to test automation, and the role of advanced modeling in a modern automation approach. This is just the marketing site, so it probably doesn't reflect core tech competencies. 

On the other hand, the value of this approach is tht this proof-of-concept already can run very advanced tests, so (say I joined Clari), then most opf our attention and effort can go to figuring out how to model and test the actual product.   

This PR includes:
* a wrapper for the Clari marketing site. This wrapper uses an advanced page object model built on my router design pattern.
